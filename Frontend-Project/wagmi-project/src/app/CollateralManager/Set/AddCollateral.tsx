...
const AddCollateral = () => {
  ...
  const submit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setErrorMsg(error?.message || 'Error calling addCollateral');
  ...
  return (
    <div className="form-container">
      ...
      <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
        ...
        <button type='submit' style={{ marginTop: '10px', background: '#c7b6f7', color: '#222', borderRadius: '6px', padding: '8px 16px', border: 'none', fontWeight: 'bold' }}>Add Collateral</button>
      </form>
      {txHash && (
