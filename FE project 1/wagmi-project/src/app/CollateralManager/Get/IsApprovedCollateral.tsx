...
const IsApprovedCollateral = () => {
    ...
    const checkApproved = async () => {
        ...
        try {
            ...
            console.error('Error checking approved collateral:', error);
        }
    };
    ...
    return (
        <div className="form-container">
            ...
            />
            <button type='button' onClick={checkApproved}>Check</button>
            <div className="admin">
                <h6>
                    Is Approved: {isApproved === null ? 'N/A' : isApproved ? 'Yes' : 'No'}
                </h6>
            </div>
        </div>
    );
